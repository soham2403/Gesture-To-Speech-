...
import { NavHeading } from "../static/staticData";
const Header = () => {
  return (
            ...
            <ul class="flex items-center gap-6 text-sm">
              {NavHeading.map((item) => (
                <li key={item}>
                  ...
                  <a
                    href={`/${item.toLowerCase()}`} // Assuming links follow a pattern
                    className="text-gray-200 hover:text-gray-700 transition px-3 py-2 rounded font-medium"
                  >
                    {item}
                  </a>
                </li>
